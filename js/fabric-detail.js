...
(function () {
  ...
  var FABRICS = [
    ...
    ['04-solid-cool', 'Tricot', 'Warp knit', 'Smooth warp-knit face with controlled stretch, dyed in Unit 2 alongside the nylon programme.', ['apparel-windbreaker-white.jpeg', 'apparel-knit-crop-jogger-set.png']],
    ['05-interlock-solid', 'Interlock', 'Double knit', 'Dense double-knit construction with a clean face on both sides. Scales to 20,000 kg a day on the double knit lines.', ['apparel-bikeshort-tee-set-mint.jpeg', 'apparel-tee-taupe.png']],
    ...
    ['07-velour-pastel', 'Velour, Brushed', 'Velour', 'The velour base taken through an additional brushing pass for a softer, more matte hand.', ['apparel-hoodie-dusty-pink.png', 'apparel-bikeshort-tee-set-mint.jpeg']],
    ['08-textured-jacquard', 'Textured Jacquard', 'Jacquard', 'Patterning knitted in rather than applied, at 18 to 24 gauge. The route for body-mapped panels.', ['apparel-hoodie-dusty-pink.png', 'apparel-bikeshort-tee-set-mint.jpeg']],
    ['09-corduroy-rib', 'Corduroy Rib', 'Rib', 'Wide-wale rib with a corduroy read, knitted at 18 gauge.', ['apparel-knit-crop-jogger-set.png', 'apparel-bomber-olive.jpeg']],
